...
namespace Backend.DAL
{
    public interface IAsignacionesDAL 
    {
        ...
        bool InsertaAsignUsuario(int pIdUsuario, int pIdActivo, DateTime FechaInicialAsignacion, DateTime FechafinalAsignacion);


        /// <summary>
        /// Método para modificar Asignacion por Usuario-Empleado existente
        /// </summary>
        bool ModificaAsignUsuario(int pIdAsignacion, int pIdUsuario, int pIdActivo, DateTime FechaInicialAsignacion, DateTime FechafinalAsignacion);
