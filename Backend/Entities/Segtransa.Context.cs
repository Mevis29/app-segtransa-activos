...
namespace Backend.Entities
{
    ...
    public partial class BDContext : DbContext
    {
        ...
        public virtual ObjectResult<spAsignUsuarioRetornaListaTotal_Result> spAsignUsuarioRetornaListaTotal()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spAsignUsuarioRetornaListaTotal_Result>("spAsignUsuarioRetornaListaTotal");
        }
        ...
        public virtual int spAsignUsuarioEliminaDatos1(Nullable<int> idAsignacion)
        {
            var idAsignacionParameter = idAsignacion.HasValue ?
                new ObjectParameter("IdAsignacion", idAsignacion) :
                new ObjectParameter("IdAsignacion", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spAsignUsuarioEliminaDatos1", idAsignacionParameter);
        }
    
        public virtual int spAsignUsuarioInsertaDatos1(Nullable<int> idUsuario, Nullable<int> idActivo)
        {
            var idUsuarioParameter = idUsuario.HasValue ?
                new ObjectParameter("IdUsuario", idUsuario) :
                new ObjectParameter("IdUsuario", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spAsignUsuarioInsertaDatos1", idUsuarioParameter, idActivoParameter);
        }
    
        public virtual int spAsignUsuarioModificaDatos1(Nullable<int> idAsignacion, Nullable<int> idUsuario, Nullable<int> idActivo)
        {
            var idAsignacionParameter = idAsignacion.HasValue ?
                new ObjectParameter("IdAsignacion", idAsignacion) :
                new ObjectParameter("IdAsignacion", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spAsignUsuarioModificaDatos1", idAsignacionParameter, idUsuarioParameter, idActivoParameter);
        }
    
        public virtual ObjectResult<spAsignUsuarioRetornaDatosId1_Result> spAsignUsuarioRetornaDatosId1(Nullable<int> idAsignacion)
        {
            var idAsignacionParameter = idAsignacion.HasValue ?
                new ObjectParameter("IdAsignacion", idAsignacion) :
                new ObjectParameter("IdAsignacion", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spAsignUsuarioRetornaDatosId1_Result>("spAsignUsuarioRetornaDatosId1", idAsignacionParameter);
        }
    
        public virtual ObjectResult<spAsignUsuarioRetornaLista1_Result> spAsignUsuarioRetornaLista1(string nombreUsuario, string codigoActivo)
        {
            var nombreUsuarioParameter = nombreUsuario != null ?
                new ObjectParameter("NombreUsuario", nombreUsuario) :
                new ObjectParameter("NombreUsuario", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spAsignUsuarioRetornaLista1_Result>("spAsignUsuarioRetornaLista1", nombreUsuarioParameter, codigoActivoParameter);
        }
    
        public virtual ObjectResult<spAsignUsuarioRetornaListaId1_Result> spAsignUsuarioRetornaListaId1(Nullable<int> idUsuario)
        {
            var idUsuarioParameter = idUsuario.HasValue ?
                new ObjectParameter("IdUsuario", idUsuario) :
                new ObjectParameter("IdUsuario", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spAsignUsuarioRetornaListaId1_Result>("spAsignUsuarioRetornaListaId1", idUsuarioParameter);
        }
    
        public virtual ObjectResult<spAsignUsuarioRetornaListaTotal1_Result> spAsignUsuarioRetornaListaTotal1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spAsignUsuarioRetornaListaTotal1_Result>("spAsignUsuarioRetornaListaTotal1");
        }
    }
}
